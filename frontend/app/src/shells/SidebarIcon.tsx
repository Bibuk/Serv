...
export type IconName =
  | 'dashboard' | 'list' | 'kanban' | 'chart' | 'pie' | 'bell' | 'settings'
  | 'users' | 'user' | 'search' | 'plus' | 'filter' | 'more' | 'arrowRight'
  | 'arrowLeft' | 'arrowUp' | 'arrowDown' | 'chevronDown' | 'chevronUp'
  | 'chevronRight' | 'x' | 'check' | 'checkCircle' | 'alert' | 'alertTri'
  | 'clock' | 'calendar' | 'flag' | 'tag' | 'layers' | 'paperclip' | 'send'
  | 'trash' | 'edit' | 'archive' | 'download' | 'upload' | 'refresh' | 'link'
  | 'zap' | 'bug' | 'message' | 'history' | 'shield' | 'cube' | 'inbox'
  | 'briefcase' | 'team' | 'monitor' | 'smartphone' | 'eye' | 'eyeOff'
  | 'logout' | 'command' | 'sliders' | 'fileText' | 'database' | 'git'
  | 'cloud' | 'trending' | 'paint' | 'home' | 'grid';
...
const PATHS: Record<IconName, React.ReactNode> = {
  ...
  bug: <><path d="M8 2l1.17 1.17"/><path d="M14.53 5L16 3.5"/><path d="M2 13h20"/><path d="M20 9v3a8 8 0 0 1-16 0V9"/><path d="M4.93 4.93l2.83 2.83"/><path d="M16.24 7.76l2.83-2.83"/><circle cx="12" cy="13" r="8"/></>,
  message: <><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></>,
  history: <><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-3.51"/></>,
...
export const SidebarIcon: React.FC<IconProps> = ({ name, size = 16 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
